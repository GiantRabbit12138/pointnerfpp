...
def compute_near_far_planes(ray_origins: torch.Tensor, ray_directions: torch.Tensor, scene_range: float, bvol=None, min_near=2., max_far=150):
    ...
    near_plane.clamp_(min=min_near, max=max_far)
    far_plane.clamp_(min=min_near, max=max_far)
