...
agg_opt="${11:-pointnet}"
plane_size="${12:-2}"
mid_conf_mode="${13:-constant_ones}"
...
nrCheckpoint="../logs/logs_cur/${suffix}/${agg_opt}_pyramid_${pyramid_opt}_backbone_${backbone_opt}_conf${mid_conf_mode}_point_emb_opt_${point_emb_opt}_vs_${backbone_voxel_size}_init_${point_init_emb_opt}_emb_level_${num_point_emb_level}_prob_freq_${prob_freq}_planesize_${plane_size}"
