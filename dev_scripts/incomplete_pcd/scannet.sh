...
nrCheckpoint="../logs/logs_cur/${suffix}/backbone_${backbone_opt}_point_emb_opt_${point_emb_opt}_vs_${backbone_voxel_size}_init_${point_init_emb_opt}_emb_level_${num_point_emb_level}_prob_freq_${prob_freq}"
