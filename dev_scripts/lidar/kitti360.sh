...
nrCheckpoint="../logs/logs_cur/${suffix}/${which_agg_model}_vsize_${vsizei}_pyramid_${pyramid_opt}_backbone_${backbone_opt}_point_emb_opt_${point_emb_opt}_vs_${backbone_voxel_size}_init_${point_init_emb_opt}_emb_level_${num_point_emb_level}_prob_freq_${prob_freq}_aggmodel_${which_agg_model}"
...
train_and_test=0 #1
test_num=10
test_freq=5000 #  #100 #1200 #1200 #30184 #30184 #50000
print_freq=40
test_num_step=1
