...
# bash dev_scripts/lidar/kitti360_dense_safe_globalnerf_pca_nocontract.sh kitti360/abs/no_contract identity mvs 2.92 learned 3 train_00 0 grid_sampling 0.08 pts_planes 2 constant_ones -2 1 trainval triplane
moremode="trainval"
